			...
			if (result) {
				if (pathArray.length > 1) {
					if (pathArray.length > 2) {
						...
						res.render('performer_list', { userpage:true, title: result.display_name, title2: config.sections[pathArray[1]].title, sez:pathArray[1], result : result, Fnc:Fnc, user : uu });
